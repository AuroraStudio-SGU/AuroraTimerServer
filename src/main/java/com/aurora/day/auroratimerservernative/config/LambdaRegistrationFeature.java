...
import com.aurora.day.auroratimerservernative.AuroraTimerServerNativeApplication;
...
public class LambdaRegistrationFeature implements Feature {
    ...
    public void duringSetup(DuringSetupAccess access) {
        ...
        RuntimeSerialization.registerLambdaCapturingClass(AuroraTimerServerNativeApplication.class);
    }
